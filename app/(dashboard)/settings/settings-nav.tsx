...
import { User, SlidersHorizontal, Bell, Wrench, Palette, Globe, Database, ArrowUpCircle, CalendarClock } from "lucide-react";
...
const TABS: {
  ...
  { href: "/settings/escalation", key: "navEscalation", icon: ArrowUpCircle },
  { href: "/settings/oncall", key: "navOncall", icon: CalendarClock },
